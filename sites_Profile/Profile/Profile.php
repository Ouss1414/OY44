...
while ($row_User = $result_user->fetch_assoc()) {
    ...
    echo '
                                    ...
                                    <p class="w3-padding"><a class="w3-margin-right" style="min-width: 100px;cursor: pointer" onclick="location.href=\'index.php?pid=Followers\'"> Followers </a>
                                    <a  class="w3-margin-left" style="min-width: 100px;cursor: pointer" onclick="location.href=\'index.php?pid=Following\'"> Following </a></p>
                                    </div>
                                    </div>
                                    <hr>
...
';
    ...
    echo '
                                    <p><button class="w3-button w3-block w3-theme-l4" onclick="location.href=\'index.php?pid=Following\'">More</button></p>
                                </div>
                            </div>
                            <br>
