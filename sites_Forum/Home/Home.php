<header>
    <div class="w3-theme-d2" style="width: 100%; max-height: 480px; padding: 50px">
        <!-- Slider -->
        <div class="slider">
...
<div class="w3-container w3-content w3-card-2 w3-white w3-round" style="max-width:1310px; margin-top: 20px">
    <!-- University Section -->
