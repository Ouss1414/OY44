...
$result_uni = $con->query("SELECT * FROM university");
        if($result_uni->num_rows > 0){
            ...
            <div class="col-sm-4 col-xs-6">
                ...
                <div class="tile-stats w3-dark-gray">
                    ...
                    <a href="ControlPanel.php?CP=Show_College&uni='.$row_uni['Name'].'"><h3 align="center">'.$row_uni['Name'].'</h3></a>
                </div>
        ...
        echo '
            ...
            <div class="col-sm-2 col-xs-6">
                ...
                <div class="tile-stats tile-green">
                    <div class="icon"><i class="entypo-graduation-cap"></i></div>
                    <a href="ControlPanel.php?CP=Add_University"><h3 align="center">Add+</h3></a>
                </div>
