...
<div class="row">
    <h2 class="margin-bottom" align="center">Add College</h2>	
        <form action="System/Add_College.php" method="post" enctype="multipart/form-data">
				<div class="tab-pane active" id="tab1" align="center">
				     <table class="table" style="max-width: 70%">
                        <tr>
                            ...
                            <td>
                                <select name="Name_uni" class="form-control" id="Name_uni" onchange="location.href=\'ControlPanel.php?CP=Add_College&uni=\'+this.value">
